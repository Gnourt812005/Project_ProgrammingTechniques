...
{
	static vector<string> soundFile{"sound\\move.wav", "sound\\enter.wav", "sound\\error.wav", "sound\\placed.wav", "sound\\win.wav",  "sound\\background.wav", "sound\\effect.wav" };
	PlaySound(soundFile[i].c_str(), NULL, SND_FILENAME | SND_ASYNC); 
}
...
void Controller::setConsoleTitle()
{
	...
	SetConsoleTitle("PIKACHU"); // PIKACHU 
}
